...
_0x0:
	.DB  0x25,0x69,0x2E,0x25,0x69,0x20,0x25,0x63
	.DB  0x20,0xA,0xD,0x0
__RESET:
	CLI
...
; 0000 0041 voltDigital = read_adc(5);                          // Read the AD conversion result pin 5
	LDI  R26,LOW(5)
	RCALL _read_adc
	STS  _voltDigital,R30
	STS  _voltDigital+1,R31
...
; 0000 0044 voltEnt = volt;                                     // Extract the integer part
	RCALL SUBOPT_0x1
	LDI  R26,LOW(_voltEnt)
	LDI  R27,HIGH(_voltEnt)
	RCALL __CFD1U
	ST   X,R30
...
; 0000 004D voltDec = volt;                                   // Extract the decimal part
	RCALL SUBOPT_0x1
	LDI  R26,LOW(_voltDec)
	LDI  R27,HIGH(_voltDec)
	RCALL __CFD1U
	ST   X,R30
; 0000 004E else{
	RJMP _0xA
